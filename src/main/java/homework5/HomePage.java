...
import homework5.page_components.LeftNavigationBar;
...
public class HomePage extends BasePage {
    ...
    public UserTablePage navigateToUserTablePageViaTopNavBar(String pageName)  {
        topNavBar.getUserTableBtn().click();
